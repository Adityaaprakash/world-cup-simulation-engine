    ...
    <Routes>
      ...
      <Route element={<ProtectedRoute />}>
        <Route element={<AppLayout />}>
          ...
          <Route path="/tournaments/:tournamentId/groups" element={<TournamentGroups />} />
          <Route path="/tournaments/:tournamentId/knockout" element={<TournamentKnockout />} />
          <Route path="/tournaments/:tournamentId/summary" element={<TournamentSummary />} />
          <Route path="/matches/:matchId" element={<MatchCentre />} />
          <Route path="/statistics" element={<Statistics />} />
          <Route path="/history" element={<Historical />} />
          <Route path="/history/:section" element={<Historical />} />
