...
import { getCareerAnalytics, getCareerHistory, getCareerStatistics, getCareerTimeline, getCurrentManager, getMyJobs } from '../api/managerApi'
...
const tabs = ['overview', 'statistics', 'performance', 'history', 'timeline', 'jobs']
const labels = { overview: 'Overview', statistics: 'Statistics', performance: 'Performance', history: 'History', timeline: 'Timeline', jobs: 'Jobs' }
const emptyData = { manager: null, statistics: null, analytics: null, history: [], timeline: [], jobs: [] }
const initialLoading = { manager: true, statistics: true, analytics: true, history: true, timeline: true, jobs: true }
...
export default function Career() {
  ...
  useEffect(() => {
    let active = true
    const requests = { manager: getCurrentManager, statistics: getCareerStatistics, analytics: getCareerAnalytics, history: getCareerHistory, timeline: getCareerTimeline, jobs: getMyJobs }
